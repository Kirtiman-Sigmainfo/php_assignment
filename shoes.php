		...
		<div class="col-md-4 w3ls_dresses_grid_left">
				...
				<h3>Categories</h3>
					<div class="w3ls_dresses_grid_left_grid_sub">
						<div class="ecommerce_dres-type">
							<ul>
								<li><a href="shoes.php">Women Shoes</a></li>
								<li><a href="shoes.php">Men shoes</a></li>
								<li><a href="shoes.php">Casual shoes</a></li>
								<li><a href="shoes.php">Running shoes</a></li>
							</ul>
						</div>
					</div>
			</div>
			<div class="w3ls_dresses_grid_left_grid">
				...
				<div class="w3ls_dresses_grid_left_grid_sub">
					<div class="ecommerce_color">
						<ul>
							<li><a href="shoes.php">Adidas</a></li>
							<li><a href="shoes.php">Fila</a></li>
							<li><a href="shoes.php">Nike</a></li>
							<li><a href="shoes.php">Osiris</a></li>
						</ul>
					</div>
				</div>
			</div>
			...
			<div class="w3ls_dresses_grid_left_grid">
				<div class="dresses_img_hover">
					<img src="images/offer11.jpg" alt=" " class="img-responsive" />
