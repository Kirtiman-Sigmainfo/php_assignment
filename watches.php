				...
				<h3>Categories</h3>
					<div class="w3ls_dresses_grid_left_grid_sub">
						<div class="ecommerce_dres-type">
							<ul>
								<li><a href="watches.php">Leather strap</a></li>
								<li><a href="watches.php">Steel strap</a></li>
								<li><a href="watches.php">Chain type</a></li>
								<li><a href="watches.php">Iron strap</a></li>
							</ul>
						</div>
					</div>
			</div>
