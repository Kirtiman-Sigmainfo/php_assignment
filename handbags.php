		...
		<div class="col-md-4 w3ls_dresses_grid_left">
				...
				<h3>Categories</h3>
					<div class="w3ls_dresses_grid_left_grid_sub">
						<div class="ecommerce_dres-type">
							<ul>
								<li><a href="handbags.php">Leather</a></li>
								<li><a href="handbags.php">Cotton Bags</a></li>
								<li><a href="skirts.html">Wallets</a></li>
								<li><a href="handbags.php">Jeans bags</a></li>
							</ul>
						</div>
					</div>
			</div>
			...
			<div class="w3ls_dresses_grid_left_grid">
				<div class="dresses_img_hover">
					<img src="images/offer4.jpg" alt=" " class="img-responsive" />
