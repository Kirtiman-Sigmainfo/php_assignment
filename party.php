		...
		<div class="col-md-4 w3ls_dresses_grid_left">
				...
				<h3>Categories</h3>
					<div class="w3ls_dresses_grid_left_grid_sub">
						<div class="ecommerce_dres-type">
							<ul>
								<li><a href="party.php">Long skirts</a></li>
								<li><a href="party.php">Frocks</a></li>
								<li><a href="party.php">Maxi dress</a></li>
							</ul>
						</div>
					</div>
			</div>
			...
			<div class="w3ls_dresses_grid_left_grid">
				<div class="dresses_img_hover">
					<img src="images/offer12.jpg" alt=" " class="img-responsive" />
