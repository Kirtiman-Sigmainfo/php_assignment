		...
		<div class="col-md-4 w3ls_dresses_grid_left">
				...
				<h3>Categories</h3>
					<div class="w3ls_dresses_grid_left_grid_sub">
						<div class="ecommerce_dres-type">
							<ul>
								<li><a href="deos.php">Nivea</a></li>
								<li><a href="deos.php">Temptation</a></li>
								<li><a href="deos.php">Axe</a></li>
								<li><a href="deos.php">Engage</a></li>
							</ul>
						</div>
					</div>
			</div>
			<div class="w3ls_dresses_grid_left_grid">
				...
				<div class="w3ls_dresses_grid_left_grid_sub">
					<div class="ecommerce_color">
						<ul>
							<li><a href="deos.php">Rose</a></li>
							<li><a href="deos.php">Chocolate</a></li>
							<li><a href="deos.php">Strawberry</a></li>
							<li><a href="deos.php">Lavender</a></li>
						</ul>
					</div>
				</div>
			</div>
			...
			<div class="w3ls_dresses_grid_left_grid">
				<div class="dresses_img_hover">
					<img src="images/offer7.jpg" alt=" " class="img-responsive" />
					...
					<a href="single.php"><div class="product-img">
						...
						<div class="p-mask">
							<form action="#" method="post">
								...
								<input type="hidden" name="w3ls1_item" value="Perfume" />
