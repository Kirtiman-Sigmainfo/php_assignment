		...
		<div class="col-md-4 w3ls_dresses_grid_left">
				...
				<h3>Categories</h3>
					<div class="w3ls_dresses_grid_left_grid_sub">
						<div class="ecommerce_dres-type">
							<ul>
								<li><a href="haircare.php">Hair oils</a></li>
								<li><a href="haircare.php">Conditioners</a></li>
								<li><a href="haircare.php">Shampoos</a></li>
								<li><a href="haircare.php">Hair boosters</a></li>
							</ul>
						</div>
					</div>
			</div>
			<div class="w3ls_dresses_grid_left_grid">
				...
				<div class="w3ls_dresses_grid_left_grid_sub">
					<div class="ecommerce_color">
						<ul>
							<li><a href="haircare.php">Olive</a></li>
							<li><a href="haircare.php">Coconut</a></li>
							<li><a href="haircare.php">Strawberry</a></li>
							<li><a href="haircare.php">Ginger</a></li>
						</ul>
					</div>
				</div>
			</div>
			...
			<div class="w3ls_dresses_grid_left_grid">
				<div class="dresses_img_hover">
					<img src="images/offer9.jpg" alt=" " class="img-responsive" />
		...
		<div class="col-md-8 col-sm-8 women-dresses">
			<div class="women-set1">
				<div class="col-md-4 women-grids wp1 animated wow slideInUp" data-wow-delay=".5s">
					<a href="single.php"><div class="product-img">
						<img src="images/hcp1.jpg" alt="" />
						<div class="p-mask">
							<form action="#" method="post">
								<input type="hidden" name="cmd" value="_cart" />
								<input type="hidden" name="add" value="1" />
								<input type="hidden" name="w3ls1_item" value="Shampoo" />
			...
			<div class="women-set3">
				<div class="col-md-4 women-grids mp7 animated wow slideInUp" data-wow-delay=".5s">
					<a href="single.php"><div class="product-img">
						<img src="images/hcp7.jpg" alt="" />
						<div class="p-mask">
							<form action="#" method="post">
								<input type="hidden" name="cmd" value="_cart" />
								<input type="hidden" name="add" value="1" />
								<input type="hidden" name="w3ls1_item" value="Conditioner" />
				...
				<div class="col-md-4 women-grids wp8 animated wow slideInUp" data-wow-delay=".5s">
					<a href="single.php"><div class="product-img">
						<img src="images/hcp8.jpg" alt="" />
						<div class="p-mask">
							<form action="#" method="post">
								<input type="hidden" name="cmd" value="_cart" />
								<input type="hidden" name="add" value="1" />
								<input type="hidden" name="w3ls1_item" value="Hair booster" />
