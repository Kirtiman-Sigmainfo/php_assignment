				...
				<h3>Categories</h3>
					<div class="w3ls_dresses_grid_left_grid_sub">
						<div class="ecommerce_dres-type">
							<ul>
								<li><a href="night.php">Night T-shirts</a></li>
								<li><a href="night.php">Night gowns</a></li>
								<li><a href="night.php">Shorts</a></li>
								<li><a href="night.php">Long T-shirts</a></li>
							</ul>
						</div>
					</div>
			</div>
			...
			<div class="women-set1">
				<div class="col-md-4 women-grids wp1 animated wow slideInUp" data-wow-delay=".5s">
					<a href="single.php"><div class="product-img">
						<img src="images/np1.jpg" alt="" />
						<div class="p-mask">
							<form action="#" method="post">
								<input type="hidden" name="cmd" value="_cart" />
								<input type="hidden" name="add" value="1" />
								<input type="hidden" name="w3ls1_item" value="Night dress" />
